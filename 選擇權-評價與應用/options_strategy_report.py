...
if strategy_name == '買權多頭價差':
    # premium
    call1_premium = int(input('Call1權利金：'))
    call2_premium = int(input('Call2權利金：'))
    # strike_price
    call1_strike_price = int(input('Call1履約價：'))
    call2_strike_price = int(input('Call2履約價：'))
    call_premium = [call1_premium, call2_premium]
    call_strike_price = [call1_strike_price, call2_strike_price]
    # 定義股票價格區間
    prices_range = np.array(range(16000, 17000, 1))
...
if strategy_name == '賣權多頭價差': 
    # premium
    put1_premium = int(input('Put1權利金：'))
    put2_premium = int(input('Put2權利金：'))
    # strike_price
    put1_strike_price = int(input('Put1履約價：'))
    put2_strike_price = int(input('Put2履約價：'))
